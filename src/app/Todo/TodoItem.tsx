    ...
    return (
        ...
        bg-neutral-700 p-5 m-3 hover: border-black border-2 border-solid rounded-lg shadow-md \
         shadow-black transition-transform transform hover:scale-105">
            ...
            <p className="col-start-1 col-span-1 mt-2 mb-5 text-sm text-white">
                {props.text}
            </p>
            <p className='text-red-700 font-extrabold sm-2 mb-1 ml-0 mr-0'>Due: {props.dueDate} </p>
            <div className='grid grid-cols-2'>
